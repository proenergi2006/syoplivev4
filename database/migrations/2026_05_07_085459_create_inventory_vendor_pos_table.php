...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('inventory_vendor_po', function (Blueprint $table) {
            ...
            $table->boolean('iuran_migas')->default(false);
            ...
            // INDEX
            $table->index('id_vendor', 'new_pro_inventory_vendor_po_idx1');
            $table->index('id_produk', 'new_pro_inventory_vendor_po_idx2');
            $table->index('id_terminal', 'new_pro_inventory_vendor_po_idx3');

            $table->unique(
                ['id_vendor', 'id_produk', 'id_terminal', 'tanggal_inven'],
                'new_pro_inventory_vendor_po_unq1'
            );
    ...
    {
        Schema::dropIfExists('inventory_vendor_po');
    }
};
